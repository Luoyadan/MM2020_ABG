...
parser.add_argument('--max_num', type=int, default=3, help='number of videos to test')
...
def eval_video(video_data):
	...
	with torch.no_grad():
		if args.tsne:
			_, _, _, _, feat_source, attn, out, _, _, feat_target = net(source_data, target_data, [0, 0, 0], 0,
