...
parser.add_argument('dataset', type=str, default="hmdb_ucf")
parser.add_argument('class_file', type=str) #default="data/classInd_" + parser.dataset + ".txt"
parser.add_argument('modality', type=str, choices=['RGB', 'Flow', 'RGBDiff', 'RGBDiff2', 'RGBDiffplus'], default='RGB')
parser.add_argument('train_source_list', type=str) #, default='./dataset/list_ucf101_train_'+dataset+'-feature.txt'
parser.add_argument('train_target_list', type=str) #, default='./dataset/list_hmdb51_train_'+dataset+'-feature.txt'
parser.add_argument('val_list', type=str) #, default='./dataset/list_hmdb51_val_'+dataset+'-feature.txt'
...
parser.add_argument('--use_attn', type=str, default='TransAttn', choices=['none', 'TransAttn', 'general', 'DotProduct'], help='attention-mechanism')
...
parser.add_argument('--exp_path', type=str,
                    help='full path of the experiment folder') #, default="experiments/"+dataset+datetime.datetime.now().strftime('-%Y%m%d-%H%M%S')+'/'
